...
use mukiza_runtime::{self, opaque::Block, RuntimeApi};
use sc_client_api::BlockBackend;
pub use sc_executor::NativeElseWasmExecutor;
use sc_service::{error::Error as ServiceError, config::Configuration, TaskManager, RpcHandlers};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		mukiza_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		mukiza_runtime::native_version()
	}
}
